...
export const Route = createFileRoute("/how-it-works")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "How Private Office works: upload your document, prepare your response, and mail it with tracking and proof of delivery." },
    ],
  }),
  component: () => (
    <>
      ...
      <main className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24">
        ...
        <p className="mt-4 max-w-2xl text-lg text-muted-foreground">
          Private Office guides you through preparing, reviewing, and mailing your document — with the same process used by legal professionals.
        </p>
