...
export const workflowProfiles: Record<WorkflowId, WorkflowProfile> = {
  ...
  "executive-crisis-response": {
    id: "executive-crisis-response", slug: "executive-crisis-response", family: "Executive & Professional", primaryKeyword: "executive crisis response",
    supportingKeywords: ["executive demand response", "executive correspondence", "reputation-sensitive business dispute", "urgent executive response letter", "regulatory inquiry response", "executive document review"], searchIntent: "commercial",
    problem: "A high-stakes executive matter involves urgent correspondence, sensitive allegations, regulatory or institutional inquiries, reputational risk, contractual conflict, or an unexpected demand requiring a controlled factual response.",
    outcome: "Create an organized executive matter file separating verified facts, reported allegations, disputed assertions, open questions, deadlines, evidence, risk, and response strategy before generating controlled correspondence.", recipientRole: "counterparty or institution",
    requiredFacts: ["executive name", "organization", "matter date", "matter description", "current counterparty position"],
    evidenceRequirements: ["incoming demand or inquiry", "relevant agreement or policy", "prior correspondence", "supporting business records", "communications with counterparties", "timeline or incident records", "relevant public statements when applicable"],
    deadlinePolicy: "Capture all dates in source materials and distinguish stated response dates from potential legal, regulatory, contractual, or procedural deadlines. Do not invent deadlines; flag time-sensitive items for verification and human review.",
    objectivePrompt: "What documented outcome are you seeking from the counterparty or institution?", draftSubject: "Executive Matter Correspondence", disclaimer: "Private Office provides document preparation, evidence organization, and mailing assistance. It is not a law firm, public-relations firm, regulator, employer, investigator, or security service and does not provide legal advice, crisis counsel, representation, determine whether allegations are true, or guarantee any outcome.",
    pricing: { preparationFee: 49.99, includedResponsePages: 5, responsePagePrice: 0.50, supportingPagePrice: 0.25, standardMail: 5.49, certifiedMail: 12.99, certifiedReturnReceipt: 18.99, registeredMail: 24.99 },
  },
  "major-purchase-due-diligence": {
    id: "major-purchase-due-diligence", slug: "major-purchase-due-diligence", family: "Major Transactions", primaryKeyword: "major purchase due diligence",
    supportingKeywords: ["high value purchase due diligence", "purchase document review", "property purchase document checklist", "business purchase due diligence", "large purchase risk review", "purchase agreement document review"], searchIntent: "commercial",
    problem: "A person is evaluating a consequential purchase and has a large set of agreements, disclosures, estimates, invoices, specifications, warranties, financing documents, inspection materials, or seller communications that need to be organized before commitment.",
    outcome: "Create a structured purchase decision brief showing documented facts, obligations, costs, contingencies, deadlines, discrepancies, missing documents, unresolved questions, and items to verify with appropriate professionals before committing.", recipientRole: "seller, dealer, broker, vendor, or transaction counterparty",
    requiredFacts: ["purchase target", "seller or counterparty", "proposed price", "purchase type", "transaction status", "known concern"],
    evidenceRequirements: ["purchase agreement or proposal", "disclosures or representations", "inspection or condition reports", "quotes estimates or invoices", "warranty or service documents", "financing or payment terms", "ownership or title records when relevant", "seller or vendor correspondence", "specifications or scope documents", "independent professional reports when available"],
    deadlinePolicy: "Capture all dates, contingencies, expiration dates, inspection periods, deposit deadlines, financing milestones, delivery dates, warranty periods, and cancellation provisions stated in source materials. Distinguish documented dates from inferred or potential deadlines. Do not invent legal or contractual deadlines. Flag material timing items for human verification before commitment.",
    objectivePrompt: "What decision or documented outcome are you trying to reach — proceed, renegotiate, request clarification, obtain missing documents, preserve a contingency, or pause the transaction?",
    draftSubject: "Major Purchase Due Diligence Correspondence",
    disclaimer: "Private Office provides document organization, evidence analysis, decision-support summaries, and correspondence preparation. It is not a law firm, financial adviser, appraiser, broker, inspector, lender, or investment adviser and does not provide legal, tax, valuation, financing, investment, or professional inspection advice or guarantee a transaction outcome.",
    pricing: { preparationFee: 44.99, includedResponsePages: 5, responsePagePrice: 0.50, supportingPagePrice: 0.25, standardMail: 5.49, certifiedMail: 12.99, certifiedReturnReceipt: 18.99, registeredMail: 24.99 },
  },
};
