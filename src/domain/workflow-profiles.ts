...
export const workflowProfiles: Record<WorkflowId, WorkflowProfile> = {
  ...
  "insurance-claim-command-center": {
    id: "insurance-claim-command-center", slug: "insurance-claim-command-center", family: "Insurance", primaryKeyword: "insurance claim management",
    supportingKeywords: ["insurance claim organizer", "insurance claim evidence checklist", "insurance claim timeline", "insurance claim documentation", "insurance claim dispute management", "insurance claim correspondence", "insurance claim command center"], searchIntent: "commercial",
    problem: "A significant insurance claim has become document-heavy or difficult to manage, with policies, estimates, photographs, adjuster communications, payments, reports, deadlines, and disputed issues spread across multiple sources.",
    outcome: "Create a centralized insurance matter record that organizes source documents, verified facts, chronology, evidence gaps, disputed issues, financial figures, known deadlines, risk signals, and a professional communication plan — while preserving source provenance and requiring human approval before consequential correspondence is mailed.", recipientRole: "insurer or claims representative",
    requiredFacts: ["insured or claimant name", "insurer name", "claim number", "policy reference", "date of loss", "loss or incident description", "current claim status"],
    evidenceRequirements: ["insurance policy or declarations page", "claim acknowledgement or claim opening notice", "claim correspondence and adjuster communications", "denial, reservation, payment, or coverage position documents when applicable", "damage photographs or videos", "repair estimates, invoices, or contractor bids", "inspection, appraisal, engineer, or specialist reports when applicable", "proof of payment and expense records", "proof of loss or other claim submissions when applicable", "temporary repair or mitigation records", "communications logs including email, letters, and call notes", "other documents supporting the asserted loss or requested resolution"],
    ...
    objectivePrompt: "What is the primary outcome you want from this insurance matter — organize the claim record, obtain a status update, challenge a denial, document an underpayment, request supplemental consideration, prepare for escalation, submit supporting evidence, or another specific documented outcome?",
