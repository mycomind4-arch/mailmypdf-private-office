...
const definitions: Array<Omit<WorkflowDefinition, "steps" | "goldStandardStages" | "pipelineArchetypes">> = [
  ...
  },
  {
    ...
    disclaimer: "Private Office provides document preparation, evidence organization, and mailing assistance. It is not a law firm and does not provide legal advice or representation.",
    lifecycle: "gold",
  },
  {
    id: "insurance-claim-command-center",
    title: "Insurance Claim Command Center",
    description: "Organize and manage a complex insurance claim across documents, evidence, communications, deadlines, payments, disputed issues, and response options — with AI-assisted matter intelligence and professionally prepared correspondence.",
