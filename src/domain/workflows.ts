export type WorkflowId = "contractor-dispute" | "property-insurance-claim" | "bank-wire-dispute" | "trust-beneficiary-notice" | "security-deposit-dispute" | "executive-crisis-response";
...
const definitions: Array<Omit<WorkflowDefinition, "steps" | "goldStandardStages" | "pipelineArchetypes">> = [
  ...
  },
  {
    ...
    description: "Document a bank or wire transfer dispute — unauthorized wires, mistaken transfers, beneficiary errors, bank refusals, delayed investigations, or disputed transactions — with transaction records, chronology, evidence, and professional correspondence.",
    disclaimer: "Private Office provides document preparation, evidence organization, and mailing assistance. It is not a law firm, bank, regulator, or law enforcement agency and does not provide legal advice, determine whether a transaction was unauthorized, or guarantee recovery.",
    lifecycle: "gold",
  },
  {
    id: "trust-beneficiary-notice",
    title: "Trust Beneficiary Notice",
    description: "Document a trust beneficiary matter — beneficiary notice, request for trust information, accounting, distribution status, trustee communication, or documentation submission — with evidence, chronology, and professional correspondence to the trustee.",
  ...
  },
  {
    ...
    description: "Document a security deposit dispute — non-return, partial return, unauthorized deductions, or disputed damage charges — with lease evidence, move-in/move-out condition documentation, correspondence, and professional correspondence to the landlord or property manager.",
  ...
  },
  {
    ...
    title: "Executive Crisis Response",
    description: "Organize and respond to a high-stakes executive matter involving urgent correspondence, sensitive allegations, regulatory or institutional inquiries, reputational risk, contractual conflict, or an unexpected demand — with chronology, evidence preservation, risk mapping, and controlled response drafting.",
