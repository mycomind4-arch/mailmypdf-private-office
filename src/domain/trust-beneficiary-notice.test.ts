...
describe("trust-beneficiary-notice: workflow registration", () => {
  ...
  it("belongs to the Trust & Estate family", async () => {
...
describe("trust-beneficiary-notice: intake and required facts", () => {
  ...
  it("blocks when trust name is missing", async () => {
    const result = await runPrivateOfficeWorkflow({
      workflowId: "trust-beneficiary-notice",
      documentId: "doc-1",
      text: "Trust text.",
  ...
  it("blocks when trustee name is missing", async () => {
    const result = await runPrivateOfficeWorkflow({
      workflowId: "trust-beneficiary-notice",
      documentId: "doc-1",
      text: "Trust text.",
  ...
  it("blocks when beneficiary name is missing", async () => {
    const result = await runPrivateOfficeWorkflow({
      workflowId: "trust-beneficiary-notice",
      documentId: "doc-1",
      text: "Trust text.",
  ...
  it("blocks when relevant date is missing", async () => {
    const result = await runPrivateOfficeWorkflow({
      workflowId: "trust-beneficiary-notice",
      documentId: "doc-1",
      text: "Trust text.",
  ...
  it("blocks when matter description is missing", async () => {
    const result = await runPrivateOfficeWorkflow({
      workflowId: "trust-beneficiary-notice",
      documentId: "doc-1",
      text: "Trust text.",
  ...
  it("blocks when trustee position is missing", async () => {
    const result = await runPrivateOfficeWorkflow({
      workflowId: "trust-beneficiary-notice",
      documentId: "doc-1",
      text: "Trust text.",
...
describe("trust-beneficiary-notice: privacy and data minimization", () => {
  ...
  it("workflow accepts facts without sensitive identifiers", async () => {
    const result = await runPrivateOfficeWorkflow({
      workflowId: "trust-beneficiary-notice",
      documentId: "doc-1",
      text: "Trust text.",
...
describe("trust-beneficiary-notice: evidence", () => {
  ...
  it("evidence items include trust-specific categories", async () => {
    const result = await runPrivateOfficeWorkflow({
      workflowId: "trust-beneficiary-notice",
      documentId: "doc-1",
      text: "Trust text.",
...
describe("trust-beneficiary-notice: analysis and findings", () => {
  it("classifies as trust-beneficiary-notice", async () => {
    const result = await runPrivateOfficeWorkflow({
      workflowId: "trust-beneficiary-notice",
      documentId: "doc-1",
      text: "Trust text.",
  ...
  it("strategy addresses the trustee as recipient", async () => {
    const result = await runPrivateOfficeWorkflow({
      workflowId: "trust-beneficiary-notice",
      documentId: "doc-1",
      text: "Trust text.",
...
describe("trust-beneficiary-notice: legal-conclusion safety", () => {
  it("does not produce findings that declare beneficiary status as verified legal fact", async () => {
    const result = await runPrivateOfficeWorkflow({
      workflowId: "trust-beneficiary-notice",
      documentId: "doc-1",
  ...
  it("does not produce findings that declare fiduciary breach", async () => {
    const result = await runPrivateOfficeWorkflow({
      workflowId: "trust-beneficiary-notice",
      documentId: "doc-1",
  ...
  it("does not produce findings that guarantee inheritance or distribution", async () => {
    const result = await runPrivateOfficeWorkflow({
      workflowId: "trust-beneficiary-notice",
      documentId: "doc-1",
      text: "Trust document text.",
  ...
  it("does not produce findings that interpret trust language as legal conclusion", async () => {
    const result = await runPrivateOfficeWorkflow({
      workflowId: "trust-beneficiary-notice",
      documentId: "doc-1",
  ...
  it("risk assessment flags incomplete intake without drawing legal conclusions", async () => {
    const result = await runPrivateOfficeWorkflow({
      workflowId: "trust-beneficiary-notice",
      documentId: "doc-1",
...
describe("trust-beneficiary-notice: draft generation", () => {
  it("generates a draft with the trust beneficiary correspondence subject line", async () => {
    const result = await runPrivateOfficeWorkflow({
      workflowId: "trust-beneficiary-notice",
      documentId: "doc-1",
      text: "Trust text.",
  ...
  it("draft does not assert legal conclusions about beneficiary status", async () => {
    const result = await runPrivateOfficeWorkflow({
      workflowId: "trust-beneficiary-notice",
      documentId: "doc-1",
      text: "Trust text.",
...
describe("trust-beneficiary-notice: matter lifecycle", () => {
  it("can create and transition a trust-beneficiary-notice matter", async () => {
  ...
  it("rejects invalid transitions for a trust-beneficiary-notice matter", async () => {
    const matter: PrivateOfficeMatter = {
      id: "matter-1",
      ownerId: "user-1",
      workflowId: "trust-beneficiary-notice",
...
describe("trust-beneficiary-notice: regression — does not affect other workflows", () => {
  ...
  it("bank-wire-dispute workflow still works independently", async () => {
  ...
  it("all four workflows use the same Gold Standard stages", async () => {
  ...
  it("all four workflows use the same pipeline archetypes", async () => {
  ...
  it("trust-beneficiary-notice has a different family than the other workflows", async () => {
