...
/**
 * Fact provenance types.
 *
 * Hierarchy of trust:
 *   user_provided     — highest trust, user explicitly provided
 *   verified          — verified against external evidence
 *   extracted         — deterministically extracted from source document
 *   externally_sourced — retrieved from an external authority source
 *   ai_suggested      — suggested by legacy AI/LLM (pre-multi-LLM)
 *   llm_generated     — generated by the LLM intelligence layer
 *   inferred          — inferred from context
 *
 * LLM-generated facts can NEVER overwrite user-provided facts.
 * Conflicts between llm_generated and user_provided facts are surfaced
 * as requires_verification findings.
 */
...
export const matterAnalysisSchema = z.object({
  ...
  generationProvenance: z
    .object({
      ...
      inputHash: z.string(),
      // Extended multi-LLM provenance fields (optional for backward compatibility)
